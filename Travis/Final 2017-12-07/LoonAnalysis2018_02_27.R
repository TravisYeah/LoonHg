...
perchBySex
ggsave("./plots/2018_02_27/perchBySex2018_02_27.pdf", perchBySex, width = 8, height = 4)
            ...
            theme_bw() +
                ylab(expression("ln(Loon blood Hg(ng/g wet weight))")) +
                    xlab(expression("ln(Standardized perch Hg (ng/g wet weight) + 1)")) +
                        theme(strip.background = element_blank())
onlyHG
ggsave("./plots/2018_02_27/onlyHG2018_02_27.pdf", onlyHG, width = 6, height = 4)
            ...
            theme_bw() +
                ylab(expression("ln(Loon blood Hg(ng/g wet weight))")) +
                    xlab(expression("Mass (kg)")) +
                        theme(strip.background = element_blank())
hgMass
ggsave("./plots/2018_02_27/hgMass2018_02_27.pdf", hgMass, width = 8, height = 4)
...
sexPlot
ggsave("./plots/2018_02_27/sexPlot2018_02_27.pdf", sexPlot, width = 6, height = 4)
...
pdf("./plots/2018_02_27/LoonHGresid2018_02_27.pdf")
par(mfcol = c(2,2))
plot(outA)
plot(outB)
plot(outC)
...
ggsave("./plots/2018_02_27/Hgpairs2018_02_27.pdf", ggpairsplot, width = 8, height = 8)
...
print(HgSeHist)
ggsave("./plots/2018_02_27/HgSeHist2018_02_27.pdf", HgSeHist, width = 6, height = 4)
...
HgSeBoxplot <- ggplot(dHg, aes(x = Sex, y = Selenium)) + geom_boxplot() + 
	theme_minimal()
print(HgSeBoxplot)
ggsave("./plots/2018_02_27/HgSeBoxplot2018_02_27.pdf", HgSeBoxplot, width = 6, height = 4)
...
sexPlotSe <- ggplot(data = dSe, aes(x = Sex, y = SeLog)) +
    ...
    geom_boxplot() + theme_bw()
sexPlotSe
ggsave("./plots/2018_02_27/sexPlotSe2018_02_27.pdf", sexPlotSe, width = 6, height = 4)
...
sexPlotSeVsHg <- ggplot(data = dSe, aes(x = HgLog, y = SeLog)) +
  ylab(expression("ln(Loon blood Se (ng/g wet weight))")) +
  xlab(expression("ln(Loon blood Hg (ng/g wet weight))")) + 
  geom_point() + stat_smooth(method = 'lm') +
  facet_grid( . ~ Sex) +
  theme_bw()
ggsave("./plots/2018_02_27/sexPlotSeVsHgUnkown2018_02_27.pdf", sexPlotSeVsHg, width = 6, height = 4)
